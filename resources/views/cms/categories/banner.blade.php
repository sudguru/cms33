...
<div id="banner">
<form action="/savecategorybanner" method="POST" enctype="multipart/form-data"  id="banner-form">
	{{ csrf_field() }}
...
<form action="/savecategorydescription" method="POST"  id="banner-description-form">
	{{ csrf_field() }}
	<div class="form-group">
