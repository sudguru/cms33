							...
							<div class="sorter">
								<div class="sort-by">
									...
									<a href="#" title="Set Desc Direction">
										<img src="/thoksaman/images/i_asc_arrow.gif" alt="Set Desc Direction">
									</a>
								</div>
						...
						<ul class="products-grid columns5 hide-addtolinks">
							<li>
								<div class="product">
									<figure class="product-image-area">
										<a href="/thoksaman/productdetail" title="Product Name" class="product-image">
											<img src="/thoksaman/images/shop11/product1.jpg" alt="Product Name">
											<img src="/thoksaman/images/shop11/product1.jpg" alt="Product Name" class="product-hover-image">
										</a>
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Noa Blouse</a></h2>
							...
							<li>
								<div class="product">
									<figure class="product-image-area">
										<a href="/thoksaman/productdetail" title="Product Name" class="product-image">
											<img src="/thoksaman/images/shop11/product2.jpg" alt="Product Name">
											<img src="/thoksaman/images/shop11/product2.jpg" alt="Product Name" class="product-hover-image">
										</a>
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Women Blouse</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
							...
							<li>
								<div class="product">
									<figure class="product-image-area">
										<a href="/thoksaman/productdetail" title="Product Name" class="product-image">
											<img src="/thoksaman/images/shop11/product3.jpg" alt="Product Name">
										</a>
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Fashion Dress</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:60%"></div>
											</div>
							...
							<li>
								<div class="product">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Fashion Sweater</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
							...
							<li>
								<div class="product">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Fashion Jacket</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
										...
										<div class="product-price-box">
											<span class="product-price">Rs.230.00</span>
										</div>
							...
							<li>
								<div class="product">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Blue Jeans</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
										...
										<div class="product-price-box">
											...
											<span class="product-price">Rs.180.00</span>
										</div>
							...
							<li>
								<div class="product">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Black top</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:0%"></div>
											</div>
							...
							<li>
								<div class="product">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Pink Dress</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:60%"></div>
											</div>
							...
							<li>
								<div class="product">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Woman Shirt</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:80%"></div>
											</div>
										...
										<div class="product-price-box">
											<span class="product-price">Rs.80.00</span>
										</div>
							...
							<li>
								<div class="product">
									...
									<div class="product-details-area">
										...
										<div class="product-price-box">
											<span class="old-price">Rs.120.00</span>
											<span class="product-price">Rs.99.00</span>
										</div>
							...
							<li>
								<div class="product">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Woman Blouse</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:0%"></div>
											</div>
						...
						<div class="owl-carousel owl-theme" data-plugin-options="{'items':1, 'margin': 5, 'dots': false, 'nav': true}">
							<div>
								<div class="product product-sm">
									<figure class="product-image-area">
										<a href="/thoksaman/productdetail" title="Product Name" class="product-image">
											<img src="/thoksaman/images/shop11/product1.jpg" alt="Product Name">
											<img src="/thoksaman/images/shop11/product11.jpg" alt="Product Name" class="product-hover-image">
										</a>
									</figure>
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Diamond Ring - S</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:0%"></div>
											</div>
										...
										<div class="product-price-box">
											<span class="product-price">Rs.220.00</span>
										</div>
									</div>
								</div>
								...
								<div class="product product-sm">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Diamond Ring - XL</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:80%"></div>
											</div>
								...
								<div class="product product-sm">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Diamond Ring - 2XL</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:0%"></div>
											</div>
										...
										<div class="product-price-box">
											<span class="product-price">Rs.240.00</span>
										</div>
									</div>
								</div>
							</div>
							...
							<div>
								<div class="product product-sm">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Diamond Ring - 3XL</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:60%"></div>
											</div>
								...
								<div class="product product-sm">
									...
									<div class="product-details-area">
										<h2 class="product-name"><a href="/thoksaman/productdetail" title="Product Name">Diamond Ring - M</a></h2>
										<div class="product-ratings">
											<div class="ratings-box">
												<div class="rating" style="width:0%"></div>
											</div>
